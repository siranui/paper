...
trait Opt{
  def update(ps:Array[DenseMatrix[Double]],ds:Array[DenseMatrix[Double]]):Array[DenseMatrix[Double]];
  def update(ps:Array[DenseVector[Double]],ds:Array[DenseVector[Double]]):Array[DenseVector[Double]];
...
class Adam(val lr:Double = 0.001,val beta1:Double = 0.9,val beta2:Double = 0.999,val epsilon:Double = 1e-8) extends Opt {
  var vms = Array[DenseMatrix[Double]]()
  var hms = Array[DenseMatrix[Double]]()
  var vvs = Array[DenseVector[Double]]()
  var hvs = Array[DenseVector[Double]]()
...
class RMSProp(val lr:Double = 0.001,val beta:Double = 0.9,val epsilon:Double = 1e-8) extends Opt {
  var hms = Array[DenseMatrix[Double]]()
  var hvs = Array[DenseVector[Double]]()
