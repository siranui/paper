...
object atFontDCGAN {
  ...
  def train(BATCH_SIZE: Int, NUM_EPOCH: Int)(TRAIN_DATA: String, DATA_SIZE: Int)(TEST_DATA: String, TEST_DATA_SIZE: Int)(GENERATED_IMAGE_PATH: String)(LOAD_PARAM_G: String, LOAD_PARAM_D: String) = {
  ...
  def main(args: Array[String]) {
    ...
    train(BATCH_SIZE, NUM_EPOCH)(TRAIN_DATA, DATA_SIZE)(TEST_DATA, TEST_DATA_SIZE)(GENERATED_IMAGE_PATH)(LOAD_PARAM_G, LOAD_PARAM_D)
