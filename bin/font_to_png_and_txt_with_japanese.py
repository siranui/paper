...
#
# USAGE: ipython font_to_png_and_txt_with_japanese.py FONT_FILE_PATH [WIDTH] [HEIGHT]
...
katakana = [chr(i) for i in range(ord('ァ'),ord('ン')+2)]


list = atoz + AtoZ + num + hiragana + katakana
